...
public class MyDrugEmballageDTO {
	...
	public static MyDrugEmballageDTO convertToDTO(MyDrugEmballage myDrugEmballage) {
		...
		myDrugEmballageDTO.setName(myDrugEmballage.getMyDrug().getName() + " " + myDrugEmballage.getMyDrug().getForme()
		        + " " + myDrugEmballage.getEmballage().getName() + "/" + myDrugEmballage.getQuantity());
