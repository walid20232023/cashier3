...
public class ManageController {
    ...
    public String showAddOrUpdateMyDrugEmballageForm(@RequestParam(value = "id", required = false) Integer myDrugEmballageId,
                                                     Model model) {
        ...
        if (myDrugEmballageId != null) {
            ...
            if (myDrugEmballage != null) {
                ...
                List<AssuranceMyDrugPrice> assuranceMyDrugPriceList = myDrugService.getAllAssuranceMyDrugPrices(myDrugEmballageId);
    ...
    public String saveMyDrugEmballage(
            @RequestParam(value = "id", required = false) Integer myDrugEmballageId,
            @RequestParam("myDrugId") Integer myDrugId,
            @RequestParam("emballageId") Integer emballageId,
            ...
            @RequestParam("prixAssurances") List<Float> prixAssurances,
            @RequestParam("taux") List<Float> taux,
            Model model) {
