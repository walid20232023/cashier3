        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <img src="${pageContext.request.contextPath}/resources.img/add.png" alt="Description de l'image" />
                    <img src="<%= request.getContextPath() %>/resources.img/add.png" alt="Description de l'image" />
