 ...
 * 'module/mycashier/mycashierLink.form'.
 */
@Controller("${rootrootArtifactId}.MycashierController")
@RequestMapping(value = "module/mycashier/mycashier.form")
public class MycashierController {
