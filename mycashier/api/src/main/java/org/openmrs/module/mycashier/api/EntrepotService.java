...
public interface EntrepotService extends OpenmrsService {
    ...
    @Transactional(readOnly = true)
    List <VenteDrug> getAllVenteDrugByEntrepotAndDrug(LocalDateTime start, LocalDateTime end, Integer myDrugId) throws APIException;
    ...
    @Transactional(readOnly = true)
    List <VenteDrug> getAllDrugApprovisByEntrepotAndDrug(LocalDateTime start, LocalDateTime end,Integer myDrugId) throws APIException;
