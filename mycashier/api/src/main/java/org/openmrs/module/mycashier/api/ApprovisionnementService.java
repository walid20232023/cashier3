...
public interface ApprovisionnementService {
    ...
    @Transactional(readOnly = true)
    List<Approvisionnement> getAllApprovisionnementsByEntrepotSource(LocalDateTime start,
                                                                     LocalDateTime end,
                                                                     Integer entrepotSource) throws APIException;

    //Les approvisionnement reçus dans un entrepot durant une période donnée
    @Transactional(readOnly = true)
    List<Approvisionnement> getAllApprovisionnementsByEntrepotCible(LocalDateTime start,
                                                                     LocalDateTime end,
    ...
    @Transactional
    void addLigneApprovisToApprovisionnement (Approvisionnement approvisionnement,
                                              MyDrug myDrug,
                                              Integer quantite) throws APIException;
