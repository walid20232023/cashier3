...
@Component
public interface VersementService extends OpenmrsService {
    ...
    @Transactional(readOnly = true)
    List<Versement> getAllVersementsByAgentSource(Integer agentSourceId,
                                                  LocalDateTime start,
    ...
    @Transactional(readOnly = true)
    List<Versement> getAllVersementsByAgentCible(Integer agentCibleId,
                                                  LocalDateTime start,
                                                  LocalDateTime end) throws APIException;
